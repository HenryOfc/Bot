...
let pp = fs.readFileSync(path.resolve('./src/fg_logo.jpg'));  // Ruta correcta a tu imagen
...
let handler = async function (m, { conn, text, usedPrefix }) {
  ...
  for (let i = 0; i < cantidadTarjetas; i++) {
    ...
    // Generamos un CVV aleatorio si el CVV es "rnd", "xxx" o vacío
  ...
  await conn.sendMessage(m.chat, {
    ...
    contextInfo: {
      ...
      "externalAdReply": {
        ...
        "containsAutoReply": true,
        "mediaType": 1,
        "thumbnail": pp,  // La imagen que ya tienes definida
        "mediaUrl": fgig,  // URL o fuente adicional de la imagen
        "sourceUrl": fgig  // La URL de la fuente
      }
    }
  });
};
